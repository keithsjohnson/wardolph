...
mongoClient.connect("mongodb://"+config.ip+":27017/wardolph", function(err, db) {
      if(!err) {
        ...
        stream.on("data", function(item) {
            ...
            for (key in item) {
                ...
                if (item.hasOwnProperty(key)) {
                	...
                	if( typeof(tweet.user.location) != 'undefined' && tweet.user.location!=null){
                		locationCount++;
                	}
                	if( typeof(tweet.user.profile_location) != 'undefined' && tweet.user.profile_location!=null){
                		profile_locationCount++;
                	}
        ...
        var printMyTestData = function(){
          ...
          console.log('tweet coordinatesCount: '+coordinatesCount);
          console.log('tweet geoCount: '+geoCount);
          console.log('tweet placeCount: '+placeCount);
          console.log('tweet locationCount: '+locationCount);
          console.log('tweet profile_locationCount: '+profile_locationCount);
