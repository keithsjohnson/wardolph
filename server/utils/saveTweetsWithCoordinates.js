...
mongoClient.connect("mongodb://"+config.ip+":27017/wardolph", function(err, db) {
      if(!err) {
        ...
        var collection = db.collection('feminism');//read from here
        var tweetCoordinate = db.collection('feminismCoordinate');//save here
        //collection.drop();
