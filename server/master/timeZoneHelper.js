var TimeZone = require('./../classes/TimeZone');
...
var init = function(){
	...
	for (var i = 0; i < rawData.length; i++) {
        var time = rawData[i];
        var timeZoneName = time[0];
        var timeZone = new TimeZone(timeZoneName,time[1],time[2],time[3]);
        timezoneCollection[timeZoneName] = timeZone;
...
exports.findTimeZoneByName = findTimeZoneByName;
